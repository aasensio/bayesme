...
! Read evidence
		...
		read(12,FMT='(16X,E28.18,5X,E28.18)') chain_analysis%evidence, chain_analysis%evidence_uncertainty
		close(12)
...
! Calculate average ln L for calculating Kullback-Leibler distance
		...
		write(13,*) 'Evidence, evidence uncertainty, <ln L>, Kullback-Leibler divergence, chi^2(min)'
		write(13,*) chain_analysis%evidence, chain_analysis%evidence_uncertainty, chain_analysis%avg_lnL, &
			-chain_analysis%evidence + chain_analysis%avg_lnL, chi2_min

		write(*,*) 'Evidence, evidence uncertainty, <ln L>, Kullback-Leibler divergence, chi^2(min)'
		write(*,*) chain_analysis%evidence, chain_analysis%evidence_uncertainty, chain_analysis%avg_lnL, &
			-chain_analysis%evidence + chain_analysis%avg_lnL, chi2_min
