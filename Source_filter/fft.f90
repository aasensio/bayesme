...
function fft_forward (c, n)
complex(dp), INTENT(IN)  :: c(:)
INTEGER, INTENT(IN)       :: n
INTEGER   :: isn
INTEGER   :: ierr
complex(dp) :: fft_forward(n)
	isn = -1
	fft_forward = fft_complex(c,n,isn,ierr) / n
RETURN
END function fft_forward

function fft_backward (c, n)
complex(dp), INTENT(IN)  :: c(:)
INTEGER, INTENT(IN)       :: n
INTEGER   :: isn
INTEGER   :: ierr
complex(dp) :: fft_backward(n)
	isn = 1
	fft_backward = fft_complex(c,n,isn,ierr)
RETURN
END function fft_backward

function fft_complex (c, n, isn, ierr)
complex(dp), INTENT(IN)  :: c(:)
INTEGER, INTENT(IN)       :: n
INTEGER, INTENT(IN OUT)   :: isn
INTEGER, INTENT(OUT)      :: ierr
complex(dp) :: fft_complex(n)
real(dp) :: a(n), b(n)
...
fft_complex = cmplx(a,b)
RETURN
10 ierr = 4
RETURN
END function fft_complex
